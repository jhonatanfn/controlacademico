...
exports.personas = [
    ...
    /*  Docentes */
    { id: 2, dni: '44409214', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'FLAVIO', apellidopaterno: 'GARCIA', apellidomaterno: 'RIVERA', tipodocumentoId: 1 },
    { id: 3, dni: '46378155', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'MILAGROS ANALY', apellidopaterno: 'GOMEZ', apellidomaterno: 'ENCALADA', tipodocumentoId: 1 },
    { id: 4, dni: '40357419', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'JOSE JAVIER', apellidopaterno: 'YARLEQUE', apellidomaterno: 'VILCHEZ', tipodocumentoId: 1 },
    { id: 5, dni: '40213876', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'DANTE JOEL', apellidopaterno: 'CABREJOS', apellidomaterno: 'REYES', tipodocumentoId: 1 },
    { id: 6, dni: '47903092', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'JORGE LUIS', apellidopaterno: 'ACARO', apellidomaterno: 'GARCIA', tipodocumentoId: 1 },
    { id: 7, dni: '44554185', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'WILLIAM', apellidopaterno: 'CALLE', apellidomaterno: 'BENITES', tipodocumentoId: 1 },
    { id: 8, dni: '02807311', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'WILMER', apellidopaterno: 'CORREA', apellidomaterno: 'GARCIA', tipodocumentoId: 1 },
    { id: 9, dni: '72199165', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'ANA BELEN', apellidopaterno: 'INGA', apellidomaterno: 'SALDARRIAGA', tipodocumentoId: 1 },
    { id: 10, dni: '46274986', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1980/04/12")).format('YYYY-MM-DD'), nombres: 'VICTOR', apellidopaterno: 'ANTO', apellidomaterno: 'MIMBELA', tipodocumentoId: 1 },
    /*  padres */
    { id: 11, dni: '42215224', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'JUAN ALBERTO', apellidopaterno: 'JUAREZ', apellidomaterno: 'CARAMANTIN', tipodocumentoId: 1 },
    { id: 12, dni: '33668077', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'JAIME RICARDO', apellidopaterno: 'PINTADO', apellidomaterno: 'CALLE', tipodocumentoId: 1 },
    { id: 13, dni: '42136288', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'JORGE', apellidopaterno: 'DIONISIO', apellidomaterno: 'CORDOVA', tipodocumentoId: 1 },
    { id: 14, dni: '40134863', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'LUIS MARTIN', apellidopaterno: 'ANASTACIO', apellidomaterno: 'CAMPOS', tipodocumentoId: 1 },
    { id: 15, dni: '41979708', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'JHOE FABIAN', apellidopaterno: 'CORDOVA', apellidomaterno: 'VILLEGAS', tipodocumentoId: 1 },
    { id: 16, dni: '28032999', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'OSCAR LUIS', apellidopaterno: 'SALDARRIAGA', apellidomaterno: 'MORAN', tipodocumentoId: 1 },
    { id: 17, dni: '80446280', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'MEDARDO', apellidopaterno: 'QUISPE', apellidomaterno: 'SAUCEDO', tipodocumentoId: 1 },
    { id: 18, dni: '25431443', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'MARTIN', apellidopaterno: 'CHUICA', apellidomaterno: 'ADRIANZEN', tipodocumentoId: 1 },
    { id: 19, dni: '33666766', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'VICTOR', apellidopaterno: 'ADRIANZEN', apellidomaterno: 'CHERRES', tipodocumentoId: 1 },
    /* madres */
    { id: 20, dni: '46538404', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'KAREN YENYFFER', apellidopaterno: 'PACHERRES', apellidomaterno: 'ODAR', tipodocumentoId: 1 },
    { id: 21, dni: '33300095', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'ZULEMA', apellidopaterno: 'PALACIOS', apellidomaterno: 'VELASQUEZ', tipodocumentoId: 1 },
    { id: 22, dni: '42337247', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'MILAGROS', apellidopaterno: 'CORDOVA', apellidomaterno: 'LOPEZ', tipodocumentoId: 1 },
    { id: 23, dni: '41940454', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'JESSICA MARIA', apellidopaterno: 'BERECHE', apellidomaterno: 'RIVAS', tipodocumentoId: 1 },
    { id: 24, dni: '41784702', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'LUCY', apellidopaterno: 'LESCANO', apellidomaterno: 'CAMPOS', tipodocumentoId: 1 },
    { id: 25, dni: '80678486', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'MARIA LUISA', apellidopaterno: 'MORALES', apellidomaterno: 'VAZQUES', tipodocumentoId: 1 },
    { id: 26, dni: '40611824', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'JULIANA', apellidopaterno: 'BAYONA', apellidomaterno: 'GARCIA', tipodocumentoId: 1 },
    { id: 27, dni: '42634953', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'FLOR', apellidopaterno: 'MAZA', apellidomaterno: 'RAMOS', tipodocumentoId: 1 },
    { id: 28, dni: '44247506', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'FIORELLA', apellidopaterno: 'AGUIRRE', apellidomaterno: 'VIERA', tipodocumentoId: 1 },
    { id: 29, dni: '43484605', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'KARINA', apellidopaterno: 'LOZADA', apellidomaterno: 'YARLEQUE', tipodocumentoId: 1 },
    /* Alumnos 1 A*/
    { id: 30, dni: '67675770', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ADRIANA FERNANDA', apellidopaterno: 'MORE', apellidomaterno: 'JUAREZ', tipodocumentoId: 1 },
    { id: 31, dni: '34776686', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'RICARDO GLEISSNER', apellidopaterno: 'PINTADO', apellidomaterno: 'ORDOÑEZ', tipodocumentoId: 1 },
    { id: 32, dni: '66796519', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'MARCO OSVALDO', apellidopaterno: 'TORRES', apellidomaterno: 'DIONISIO', tipodocumentoId: 1 },
    { id: 33, dni: '23522439', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ANDERSON ASAEL', apellidopaterno: 'LOZADA', apellidomaterno: 'ANASTACIO', tipodocumentoId: 1 },
    { id: 34, dni: '94375916', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'KEVIN', apellidopaterno: 'PALACIOS', apellidomaterno: 'CORDOVA', tipodocumentoId: 1 },
    { id: 35, dni: '79069307', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ALONSO', apellidopaterno: 'INGA', apellidomaterno: 'SALDARRIAGA', tipodocumentoId: 1 },
    { id: 36, dni: '56066411', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'MARIA FERNANDA', apellidopaterno: 'JIMENEZ', apellidomaterno: 'QUISPE', tipodocumentoId: 1 },
    { id: 37, dni: '93625136', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'JUNIOR MARTIN', apellidopaterno: 'CHUICA', apellidomaterno: 'MONTENEGRO', tipodocumentoId: 1 },
    { id: 38, dni: '95831424', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ALEXANDRA', apellidopaterno: 'CORNEJO', apellidomaterno: 'ADRIANZEN', tipodocumentoId: 1 },
    { id: 39, dni: '18205639', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'DANNA', apellidopaterno: 'DURAN', apellidomaterno: 'PACHERRES', tipodocumentoId: 1 },
    /* Alumnos 2 A*/
    { id: 40, dni: '96483020', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ERICK', apellidopaterno: 'ALVARADO', apellidomaterno: 'BERMEO', tipodocumentoId: 1 },
    { id: 41, dni: '90216663', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'CARLOS ROLANDO', apellidopaterno: 'APONTE', apellidomaterno: 'BURNEO', tipodocumentoId: 1 },
    { id: 42, dni: '52389341', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'PIERO', apellidopaterno: 'CAMPOS', apellidomaterno: 'MORE', tipodocumentoId: 1 },
    { id: 43, dni: '45014214', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ALEX FABIAN', apellidopaterno: 'CRUZ', apellidomaterno: 'CORDOVA', tipodocumentoId: 1 },
    { id: 44, dni: '75024117', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'LEYLA', apellidopaterno: 'GARCIA', apellidomaterno: 'SERNAQUE', tipodocumentoId: 1 },
    { id: 45, dni: '12892836', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ENRIQUE NAPOLEAN', apellidopaterno: 'GUZMAN', apellidomaterno: 'GARCIA', tipodocumentoId: 1 },
    { id: 46, dni: '52730003', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ERICK', apellidopaterno: 'JIMENEZ', apellidomaterno: 'GARCIA', tipodocumentoId: 1 },
    { id: 47, dni: '94442585', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'JIMENA', apellidopaterno: 'PALACIOS', apellidomaterno: 'BERECHE', tipodocumentoId: 1 },
    { id: 48, dni: '39099454', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ALEXIS', apellidopaterno: 'ROJAS', apellidomaterno: 'PACHERREZ', tipodocumentoId: 1 },
    { id: 49, dni: '15775569', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ALLISON JIMENA', apellidopaterno: 'VIDAL', apellidomaterno: 'SANCHEZ', tipodocumentoId: 1 },
    /* Alumnos 1 B*/
    { id: 50, dni: '61943078', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'JURGEN KLINSMAN', apellidopaterno: 'ATOCHE', apellidomaterno: 'TALLEDO', tipodocumentoId: 1 },
    { id: 51, dni: '61769085', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'CHRISTIAN LEONARDO', apellidopaterno: 'ALVARADO', apellidomaterno: 'AREVALO', tipodocumentoId: 1 },
    { id: 52, dni: '61988111', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'EDWIN JARITH', apellidopaterno: 'CACERES', apellidomaterno: 'RENTERIA', tipodocumentoId: 1 },
    { id: 53, dni: '61987674', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'DOUGLAS LEONEL', apellidopaterno: 'CARLIN', apellidomaterno: 'ORTIZ', tipodocumentoId: 1 },
    { id: 54, dni: '61372273', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'DAMARIS NYKOLL', apellidopaterno: 'CHIROQUE', apellidomaterno: 'ESPINOZA', tipodocumentoId: 1 },
    { id: 55, dni: '61436546', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'JUNIOR BRANDY', apellidopaterno: 'CRUZ', apellidomaterno: 'RUEDA', tipodocumentoId: 1 },
    { id: 56, dni: '76881046', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'YEREMI ALEXANDER', apellidopaterno: 'DAVILA', apellidomaterno: 'REYES', tipodocumentoId: 1 },
    { id: 57, dni: '73408800', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'RAFAEL EDUARDO', apellidopaterno: 'GALECIO', apellidomaterno: 'SALCEDO', tipodocumentoId: 1 },
    { id: 58, dni: '61987735', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'OSCAR STEPHANO', apellidopaterno: 'REYES', apellidomaterno: 'RIVERA', tipodocumentoId: 1 },
    { id: 59, dni: '61854510', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ALBERT SNAYDER', apellidopaterno: 'ZAPATA', apellidomaterno: 'ESTRADA', tipodocumentoId: 1 },
    /* Alumnos 2 B*/
    { id: 60, dni: '61768339', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'JERICKSON JHAIR', apellidopaterno: 'ABAD', apellidomaterno: 'GARCIA', tipodocumentoId: 1 },
    { id: 61, dni: '61501424', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'YARUMY ALEXANDRA', apellidopaterno: 'ALAMA', apellidomaterno: 'TAVARA', tipodocumentoId: 1 },
    { id: 62, dni: '61500914', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'ERWUINS ALEXANDER', apellidopaterno: 'ALCERO', apellidomaterno: 'NORES', tipodocumentoId: 1 },
    { id: 63, dni: '61768272', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'BIANCA CAMILLA', apellidopaterno: 'BENITES', apellidomaterno: 'DIOSES', tipodocumentoId: 1 },
    { id: 64, dni: '61436218', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'WILLIAM JUNIOR', apellidopaterno: 'CARRASCO', apellidomaterno: 'CARHUAPOMA', tipodocumentoId: 1 },
    { id: 65, dni: '61500797', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'BRIANA ALMUDENA', apellidopaterno: 'CASTRO', apellidomaterno: 'SIANCAS', tipodocumentoId: 1 },
    { id: 66, dni: '62027706', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'MANUEL ENRIQUE', apellidopaterno: 'NAVARRETE', apellidomaterno: 'TABOADA', tipodocumentoId: 1 },
    { id: 67, dni: '62968255', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'BRENDY NATALY', apellidopaterno: 'SAAVEDRA', apellidomaterno: 'CHAVEZ', tipodocumentoId: 1 },
    { id: 68, dni: '61386848', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'JUAN MANUEL', apellidopaterno: 'UBILLUS', apellidomaterno: 'MADRID', tipodocumentoId: 1 },
    { id: 69, dni: '62027884', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("2010/04/12")).format('YYYY-MM-DD'), nombres: 'SERGIO ALFREDO', apellidopaterno: 'ZAPATA', apellidomaterno: 'MORENO', tipodocumentoId: 1 },
    /** auxiliares */
    { id: 70, dni: '81061664', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'FRANKLIN', apellidopaterno: 'APONTE', apellidomaterno: 'QUINTANA', tipodocumentoId: 1 },
    { id: 71, dni: '43195779', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'FAVIOLA', apellidopaterno: 'TEZEN', apellidomaterno: 'CHERO', tipodocumentoId: 1 },
    { id: 72, dni: '47503406', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1985/04/12")).format('YYYY-MM-DD'), nombres: 'JAVIER ALONSO', apellidopaterno: 'JUAREZ', apellidomaterno: 'BERECHE', tipodocumentoId: 1 },
    /** directores */
    { id: 73, dni: '52639852', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1965/04/12")).format('YYYY-MM-DD'), nombres: 'JOSE EDUARDO', apellidopaterno: 'AGURTO', apellidomaterno: 'NOLE', tipodocumentoId: 1 },
    { id: 74, dni: '54784168', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1965/04/12")).format('YYYY-MM-DD'), nombres: 'MILAGROS DEL ROSARIO', apellidopaterno: 'SANDOVAL', apellidomaterno: 'VASQUEZ', tipodocumentoId: 1 },
    { id: 75, dni: '49632582', sexo: 2, fechanacimiento: (0, moment_1.default)(new Date("1965/04/12")).format('YYYY-MM-DD'), nombres: 'ANA CELINDA', apellidopaterno: 'ORTIZ', apellidomaterno: 'FALCON', tipodocumentoId: 1 },
    { id: 76, dni: '41528799', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1965/04/12")).format('YYYY-MM-DD'), nombres: 'CESAR', apellidopaterno: 'AGUIRRE', apellidomaterno: 'NAVARRO', tipodocumentoId: 1 },
    { id: 77, dni: '00000000', sexo: 1, fechanacimiento: (0, moment_1.default)(new Date("1979/04/12")).format('YYYY-MM-DD'), nombres: 'DESCONOCIDO', apellidopaterno: 'DESCONOCIDO', apellidomaterno: 'DESCONOCIDO', tipodocumentoId: 1 },
];
exports.usuarios = [
    /** ADMINISTRADOR */
