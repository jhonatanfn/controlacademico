...
router.get('/alumno/:numero', validar_jwt_1.validarJWT, alumno_1.getAlumnoNumero);
...
router.post('/', [
    ...
    (0, express_validator_1.check)('apoderadoId', 'El id del apoderado es obligatorio').not().isEmpty(),
