...
router.get('/existe/:periodo/:aula/:subarea', validar_jwt_1.validarJWT, programacion_1.existeProgramacion);
...
router.post('/', [
    ...
    (0, express_validator_1.check)('subareaId', 'El subarea es obligatorio').not().isEmpty(),
